...
function App() {
  ...
  const filterTaskList = () => {
    const newList = selectedCategory === "All" ? tasks : tasks.filter((task) => task.category === selectedCategory);
  ...
  return (
    <div className="App">
      <h2>My tasks</h2>
      <CategoryFilter categories={CATEGORIES} setCategory={setSelectedCategory} selectedCategory={selectedCategory} />
